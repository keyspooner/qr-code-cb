...
document.getElementById("uploadImage").onclick = function () {
  ...
  if (sampleId.trim() == '') {
    ...
    //Determine how many images results need to be displayed
...
document.getElementById("submitImages").onclick = function () {
  //Find number of image children
  let imageCount = document.getElementById("imagesToUpload").childElementCount;
  alert(imageCount);
} 
